...
Card.create(title: "Nostrud ligula", content: post1, user: u1, tags: [tutorial_tag])
Card.create(title: "Designer", content: link1, user: u2, tags: [web_design_tag])
...
Card.create(title: "My Desk", content: image2, user: u2, tags: [desk_tag])
Card.create(title: "Fames nulla", content: post3, user: u2, tags: [tutorial_tag])
Card.create(title: "Search engine", content: link2, user: u1)
