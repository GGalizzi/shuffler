...
b1 = Deck.create(name: "The stuff", user: u1)
b2 = Deck.create(name: "Design", user: u2)
...
Card.create(title: "Nostrud ligula", content: post1, user: u1, tags: [tutorial_tag], deck: b1)
Card.create(title: "Search engine", content: link2, user: u1, deck: b1)
Card.create(title: "Hun Bow", content: image3, user: u1, tags: [archery_tag])

Card.create(title: "Designer", content: link1, user: u2, tags: [web_design_tag], deck: b2)
Card.create(title: "My Desk", content: image2, user: u2, tags: [desk_tag], deck: b2)
Card.create(title: "Fames nulla", content: post3, user: u2, tags: [tutorial_tag], deck: b2)
